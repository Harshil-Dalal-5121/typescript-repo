...
type useContextContextType = ReturnType<typeof useCounterContext>;

const initialContextState: useContextContextType = {
  state: initialState,
  increment: () => {},
  decrement: () => {},
...
export const CounterContext =
  createContext<useContextContextType>(initialContextState);
